               ...
               <div className="overflow-y-auto custom-scrollbar flex-1 pr-2 space-y-2">
                 {loadingDevice ? (
                   ...
                   currentDevice.cameras.map((cam, idx) => (
                     <div key={idx} className="flex items-center justify-between p-2.5 bg-slate-800/50 hover:bg-slate-800 rounded-lg border border-slate-700/50 group transition-colors">
                       <span className="text-xs text-white font-medium truncate max-w-[150px]">{cam.name || `Channel ${cam.channel_number}`}</span>
